...
class game(Tk):
    def __init__(self, world, openDoors, flags, start1, start2, goal):
        ...
        self.canvas = Canvas(
            self,
            width=self.width * self.gridSize + self.pad,
            height=self.height * self.gridSize + self.pad,
            bg="white",
        )
    ...
    def drawWorld(self):
        ...
        self.canvas.create_text(
            self.goal[0] * self.gridSize + self.pad + 5,
            self.goal[1] * self.gridSize + self.pad + 5,
            text="G",
            font="Arial 16",
        )
    ...
    def colorSquare(self, x, y, color):
        self.canvas.create_rectangle(
            x * self.gridSize + self.pad / 2,
            y * self.gridSize + self.pad / 2,
            x * self.gridSize + self.pad / 2 + self.gridSize,
            y * self.gridSize + self.pad / 2 + self.gridSize,
            fill=color,
        )

    def colorMiniSquare(self, x, y, color):
        self.canvas.create_rectangle(
            x * self.gridSize + self.pad / 2 + 10,
            y * self.gridSize + self.pad / 2 + 10,
            x * self.gridSize + self.pad / 2 + self.gridSize - 10,
            y * self.gridSize + self.pad / 2 + self.gridSize - 10,
            fill=color,
        )

    def drawHoriZontalLine(self, x1, x2, y, lineWidth, color="black"):
        self.canvas.create_line(
            x1 * self.gridSize + self.pad / 2,
            y * self.gridSize + self.pad / 2,
            x2 * self.gridSize + self.pad / 2,
            y * self.gridSize + self.pad / 2,
            width=lineWidth,
            fill=color,
        )
    ...
    def drawVerticalLine(self, y1, y2, x, lineWidth, color="black"):
        self.canvas.create_line(
            x * self.gridSize + self.pad / 2,
            y1 * self.gridSize + self.pad / 2,
            x * self.gridSize + self.pad / 2,
            y2 * self.gridSize + self.pad / 2,
            width=lineWidth,
            fill=color,
        )
    ...
    def drawFlag(self, x, y):
        self.canvas.create_line(
            self.pad / 2 + y * self.gridSize + 15,
            self.pad / 2 + x * self.gridSize + 5,
            self.pad / 2 + y * self.gridSize + 15,
            self.pad / 2 + x * self.gridSize + 25,
            fill="black",
            width=3,
        )
        self.canvas.create_line(
            self.pad / 2 + y * self.gridSize + 5,
            self.pad / 2 + x * self.gridSize + 12,
            self.pad / 2 + y * self.gridSize + 15,
            self.pad / 2 + x * self.gridSize + 5,
            fill="black",
            width=3,
        ...
        self.canvas.create_line(
            self.pad / 2 + y * self.gridSize + 9,
            self.pad / 2 + x * self.gridSize + 15,
            self.pad / 2 + y * self.gridSize + 15,
            self.pad / 2 + x * self.gridSize + 7,
            fill="black",
            width=5,
        )
        self.canvas.create_line(
            self.pad / 2 + y * self.gridSize + 13,
            self.pad / 2 + x * self.gridSize + 18,
            self.pad / 2 + y * self.gridSize + 14,
            self.pad / 2 + x * self.gridSize + 9,
            fill="black",
            width=5,
        )
        self.canvas.create_line(
            ...
            self.pad / 2 + x * self.gridSize + 12,
            self.pad / 2 + y * self.gridSize + 15,
            self.pad / 2 + x * self.gridSize + 17,
            fill="black",
            width=3,
        )
        self.canvas.create_line(
            self.pad / 2 + y * self.gridSize + 7,
            self.pad / 2 + x * self.gridSize + 25,
            self.pad / 2 + y * self.gridSize + 23,
            self.pad / 2 + x * self.gridSize + 25,
            fill="black",
            width=3,
        )
